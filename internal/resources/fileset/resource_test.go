...
func TestFilesetResource_Create(t *testing.T) {
	var receivedBody models.FilesetCreateRequest
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		resp := models.FilesetResponse{
			...
			Fileset: models.Fileset{
				...
				StorageLocation: receivedBody.StorageLocation,
	...
	planModel := res.FilesetResourceModel{
		...
		StorageLocation: types.StringValue("s3://bucket/path"),
	...
	if receivedBody.Name != "test_fileset" {
		t.Errorf("expected name test_fileset, got %s", receivedBody.Name)
	}
}

func TestFilesetResource_ImportState(t *testing.T) {
	...
	nullModel := res.FilesetResourceModel{
	...
	req := resource.ImportStateRequest{
		ID: "my_metalake.my_catalog.my_schema.my_fileset",
	}
...
func TestFilesetResource_ImportState_Invalid(t *testing.T) {
	r := res.New().(resource.ResourceWithImportState)
...
func TestFilesetResource_Delete(t *testing.T) {
	...
	stateModel := res.FilesetResourceModel{
		ID:         types.StringValue("test_metalake.test_catalog.test_schema.test_fileset"),
		Metalake:   types.StringValue("test_metalake"),
		Catalog:    types.StringValue("test_catalog"),
		Schema:     types.StringValue("test_schema"),
		Name:       types.StringValue("test_fileset"),
